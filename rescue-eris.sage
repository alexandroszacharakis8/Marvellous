...
eris_scalar = 102211695604070082112571065507755096754575920209623522239390234855480569854275933742834077002685857629445612735086326265689167708028929

## Create parameters for F_{eris_scalar} with state width 4 and \alpha = 5
rescue_pallas = Rescue(128, eris_scalar, 4, 5)
...
print("pub(super) const ERIS_COUNTER_MODE_MSG: [[Fp; 4]; 4] = [")
...
print("pub(super) const ERIS_COUNTER_MODE_KEY: [Fp; 4] = ")
print("[")
...
print("pub(super) const ERIS_COUNTER_MODE_OUT: [[Fp; 4]; 4] = [")
